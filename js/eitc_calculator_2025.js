...
var EITC_Calculator = function() {
    ...
    c.parms = {
        "0": {
            "earned_income_base_amount": 8490,
            "begin_phaseout": 10620,
            "marriage_penalty_relief": 7110,
            "phase_in_rate": 0.0765,
            "phase_out_rate": 0.0765
        },
        "1": {
            "earned_income_base_amount": 12730,
            "begin_phaseout": 23350,
            "marriage_penalty_relief": 7120,
            "phase_in_rate": 0.34,
            "phase_out_rate": 0.1598
        },
        "2": {
            "earned_income_base_amount": 17880,
            "begin_phaseout": 23350,
            "marriage_penalty_relief": 7120,
            "phase_in_rate" : 0.4,
    ...
    c.calculate = function(inputs, ignoreIRSTableBins) {
        ...
        //ignoreIRSTableBins = true;
       // console.log(ignoreIRSTableBins);
        ...
        /*total potential EITC*/ gross_eitc = Math.round(Math.min(rounded_wages, parms.earned_income_base_amount)*parms.phase_in_rate),
